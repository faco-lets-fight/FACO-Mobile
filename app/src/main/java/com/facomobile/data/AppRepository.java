...
import com.facomobile.data.database.UserDao;
import com.facomobile.data.network.FirebaseNetworkOperations;
import com.facomobile.ui.SplashActivity;
...
public class AppRepository {
    ...
    private AppRepository(UserDao userDao, FirebaseNetworkOperations firebaseNetworkOperations,
    ...
    public synchronized static AppRepository getInstance(UserDao userDao,
                                                         FirebaseNetworkOperations firebaseNetworkOperations,
                                                         AppExecutors executors) {
        Log.d(LOG_TAG, "Getting the repository");
        if (sInstance == null) {
            synchronized (LOCK) {
                sInstance = new AppRepository(userDao, firebaseNetworkOperations, executors);
